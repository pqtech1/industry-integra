  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/40 via-black/40 to-transparent" />
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Button className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-6 text-lg font-semibold rounded-lg shadow-xl">
                  <Link
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Industry INTEGRA 360 Factory KPIs We Cover
              </h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Industry INTEGRA 360 Factory Automation Dashboard
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="relative w-full">
              <div className="bg-gradient-to-br from-gray-900 via-slate-900 to-blue-900 rounded-2xl p-6 md:p-10 shadow-2xl border border-white/10">
                {/* Dashboard Title */}
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-red-50 rounded-xl p-6 border border-red-200">
                    ...
                    <p className="text-gray-700">
                      Unoptimized consumption increasing operational costs
                    </p>
                  </div>
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                ...
                <p className="text-sm text-gray-600">First-pass quality rate</p>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-block p-6 rounded-2xl bg-gradient-to-r from-blue-500 to-green-500 mb-8">
              <FaIndustry className="h-16 w-16 text-white" />
            </div>
