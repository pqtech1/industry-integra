...
const SolutionsPage = () => {
  ...
  const handleDemoRequest = () => {
    alert(
      "Thank you for your interest! Our solutions expert will contact you within 24 hours to schedule a personalized demo.",
    );
  };
  ...
  const handleConsultationRequest = () => {
    alert(
      "Our industry specialist will reach out to discuss your specific requirements and provide tailored recommendations.",
    );
  };
              ...
              <div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    Request Predictive Maintenance Demo
                  </div>
                </Button>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 mb-16">
              ...
              <div>
                ...
                >
                  <div className="flex items-center gap-3">
                    <FaCalendarCheck className="h-5 w-5" />
                    Request Energy Optimization Demo
                  </div>
                </Button>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 text-white mb-6">
            ...
            <div className="mb-20">
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <div className="mt-8">
                    <Button
                      className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-4"
                      onClick={handleConsultationRequest}
                    >
                      <div className="flex items-center justify-center gap-3">
                        <FaUsers className="h-5 w-5" />
                        Automotive Industry Consultation
                      </div>
                    </Button>
                  </div>
                </div>
            ...
            <div className="mb-20">
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <div className="mt-8">
                    <Button
                      className="w-full bg-gradient-to-r from-green-600 to-green-700 text-white py-4"
                      onClick={handleConsultationRequest}
                    >
                      <div className="flex items-center justify-center gap-3">
                        <FaUsers className="h-5 w-5" />
            ...
            <div className="mb-20">
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["PLC", "Vision Systems", "WMS", "ERP", "IoT"].map(
                      (tech, index) => (
                        <span
                          key={index}
                          className="px-3 py-2 bg-orange-50 text-orange-700 rounded-lg text-sm"
                        >
                          {tech}
                        </span>
                      ),
                  ...
                  <div className="mt-8">
                    <Button
                      className="w-full bg-gradient-to-r from-orange-600 to-orange-700 text-white py-4"
                      onClick={handleConsultationRequest}
                    >
                      <div className="flex items-center justify-center gap-3">
                        <FaUsers className="h-5 w-5" />
                        FMCG Industry Consultation
                      </div>
                    </Button>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <div className="mt-8">
                    <Button
                      className="w-full bg-gradient-to-r from-purple-600 to-purple-700 text-white py-4"
                      onClick={handleConsultationRequest}
                    >
                      <div className="flex items-center justify-center gap-3">
                        <FaUsers className="h-5 w-5" />
                        Chemical Industry Consultation
                      </div>
                    </Button>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="p-4 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 text-white">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-8">
                ...
                <Button
                  className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-4"
                  onClick={handleDemoRequest}
                >
                  <div className="flex items-center justify-center gap-3">
                    <FaPlay className="h-5 w-5" />
                    Plant Digitization Demo
                  </div>
                </Button>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-8">
                ...
                <Button
                  className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-4"
                  onClick={handleDemoRequest}
                >
                  <div className="flex items-center justify-center gap-3">
                    <FaPlay className="h-5 w-5" />
            ...
            <div className="grid md:grid-cols-5 gap-6">
              {[
                ...
                <div key={index} className="text-center">
                  <div
                    className={`h-16 w-16 bg-gradient-to-r from-${item.color}-500 to-${item.color}-600 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4`}
                  >
                    {item.step}
                  </div>
